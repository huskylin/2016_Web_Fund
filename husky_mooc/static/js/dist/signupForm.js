...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(registerApp);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { className: 'from-control', id: 'exampleInputEmail1', placeholder: 'Username', type: 'text', ref: 'username' }),
	          _react2.default.createElement('br', null)
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'form-gruop' },
	          _react2.default.createElement('input', { className: 'from-control', id: 'exampleInputEmail1', placeholder: 'Password', type: 'password', ref: 'password' }),
	          _react2.default.createElement('br', null)
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'form-gruop' },
	          _react2.default.createElement('input', { className: 'from-control', id: 'exampleInputEmail1', placeholder: 'Password again', type: 'password', ref: 'passwordRepeat' }),
	          _react2.default.createElement('br', null)
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'form-gruop' },
	          _react2.default.createElement('input', { className: 'from-control', id: 'exampleInputEmail1', placeholder: 'Email', type: 'email', ref: 'email' }),
	          _react2.default.createElement('br', null)
	        ),
	        _react2.default.createElement(
	          'button',
	    ...
	    value: function handleSubmit(e) {
	      ...
	      var registerFail = this.props.actions.registerFail;


	      var usernameNode = this.refs.username;
	      var passwordNode = this.refs.password;
	      var passwordRepeatNode = this.refs.passwordRepeat;
	      var emailNode = this.refs.email;

	      var username = usernameNode.value;
	      var password = passwordNode.value;
	      var passwordRepeat = passwordRepeatNode.value;
