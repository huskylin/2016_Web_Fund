...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(postApp);
	...
	PostItem.propTypes = {
	  post: _react.PropTypes.shape({
	    ...
	    date: _react.PropTypes.string.isRequred
	  }).isRequired
	};
	...
	var PostList = function (_Component2) {
	  ...
	  function PostList(props) {
	    ...
	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(PostList).call(this, props));

	    _this2.handleClick = _this2.handleClick.bind(_this2);
	    _this2._loadPost = _loadPost.bind(_this2);
	    return _this2;
	  }
	    ...
	    value: function render() {
	      ...
	      var postElements = posts.map(function (post) {
	        return _react2.default.createElement(
	          'li',
	          { key: post.id },
	          _react2.default.createElement(PostItem, { post: post })
	        );
	      });
	...
	PostList.propTypes = {
	  minId: _react.PropTypes.number.isRequired,
	  maxId: _react.PropTypes.number.isRequired,
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { method: 'POST', id: 'postForm', onSubmit: this.handleSubmit },
	          'Content: ',
	          _react2.default.createElement('input', { type: 'text', ref: 'content' }),
	    ...
	    value: function handleSubmit(e) {
	      ...
	      var postFail = _props$actions2.postFail;
	      var postSuccess = _props$actions2.postSuccess;
